import { ArrowLeft, ArrowRight, Check, CreditCard, FileText, LockKeyhole, MapPin, PackageCheck, ShieldCheck, Smartphone, Sparkles } from "lucide-react";
...
export default function CheckoutPage() {
  ...
  const submit = async (event) => {
    ...
    const checkoutBody = {
      ...
      paymentMethod,
      compliance: highValue ? { documentType, panNumber, form60Declaration, otpToken } : null,
      shippingAddress: {
